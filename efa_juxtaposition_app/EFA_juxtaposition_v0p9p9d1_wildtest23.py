...
class EFA_juxtaposition(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.notebook.add(self.juxtaposition_unit_frame, text='Juxtaposition Unit Plot')
        self.notebook.add(self.juxtaposition_plot_frame, text='Juxtaposition Lith. Plot')
...
"""
    ...
    def create_unit_legend(self, hcolor_df):
        """
        Create a legend for the juxtaposition unit plot.
        """
        legend_items = []
        legend_items.append(Patch(facecolor='white', edgecolor='white', label='Horizons'))
        for index, row in hcolor_df.iterrows():
